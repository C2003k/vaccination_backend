...
export const login = async (req, res) => {
  try {
    ...
    // Validate input: ensure at least one identifier (email or username) and password are provided
    ...
    // Call the login service, passing both email and username if available
